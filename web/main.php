...
$users = $db->query("SELECT * FROM amjd2018")->fetchAll();

$groups = $db->query("SELECT groupe, COUNT(id) AS number FROM `amjd2018`GROUP BY groupe ORDER BY groupe ASC")->fetchAll();
$image = new Image();
